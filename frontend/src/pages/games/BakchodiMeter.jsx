...
const BakchodiMeter = () => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true)
    try {
      const response = await api.post('/games/bakchodiMeter', { bakchodi_text: bakchodiText })
        ...
        <div className="bg-white bg-opacity-90 rounded-3xl p-6 shadow-2xl">
          <div className="space-y-4">
            <textarea
              ...
              placeholder="Apna bakchodi text yahan likho..."
          ...
          {result && (
            <div className="mt-6 bg-orange-100 rounded-lg p-4">
              ...
              <p className="text-lg mt-2">Level: {result.bakchodi_level}</p>
              {result.bakchodi_level === 'legendary' && <p className="text-yellow-600 font-bold">🏆 LEGENDARY!</p>}
